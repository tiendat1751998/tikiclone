...
func Load() *Config {
	return &Config{
		AppName:  getEnv("APP_NAME", "tiki-notification"),
		AppEnv:   getEnv("APP_ENV", "development"),
		LogLevel: getEnv("LOG_LEVEL", "info"),
		HTTPPort: getEnvInt("NOTIFICATION_HTTP_PORT", 8087),
		GRPCPort: getEnvInt("NOTIFICATION_GRPC_PORT", 9097),
		...
		MySQL: MySQLConfig{
			...
			Database:     getEnv("MYSQL_DATABASE", "tiki_notification"),
		...
		OpenTelemetry: OTELConfig{
			...
			ServiceName: getEnv("OTEL_SERVICE_NAME", "tiki-notification"),
