...
import (
	...
	"github.com/tikiclone/tiki/services/rec-vector/internal/health"
	"github.com/tikiclone/tiki/services/rec-vector/internal/infrastructure/mysql"
	redisinfra "github.com/tikiclone/tiki/services/rec-vector/internal/infrastructure/redis"
	"github.com/tikiclone/tiki/services/rec-vector/internal/tracing"
	httptransport "github.com/tikiclone/tiki/services/rec-vector/internal/transport/http"
...
func main() {
	...
	svc := application.NewRecService(repo, redisStore, &cfg.Recommendation)
	...
	go func() {
		logger.Info("starting rec-vector service",
	...
	<-ctx.Done()
	logger.Info("shutting down rec-vector service...")
	...
	logger.Info("rec-vector service stopped")
}
