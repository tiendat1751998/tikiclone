...
func Load() *Config {
	return &Config{
		AppName:  getEnv("APP_NAME", "tiki-payment-ledger"),
		AppEnv:   getEnv("APP_ENV", "development"),
		LogLevel: getEnv("LOG_LEVEL", "info"),
		HTTPPort: getEnvInt("LEDGER_HTTP_PORT", 8097),
		GRPCPort: getEnvInt("LEDGER_GRPC_PORT", 9097),
		...
		MySQL: MySQLConfig{
			...
			Database:     getEnv("MYSQL_DATABASE", "tiki_payment_ledger"),
		...
		OpenTelemetry: OTELConfig{
			...
			ServiceName: getEnv("OTEL_SERVICE_NAME", "tiki-payment-ledger"),
